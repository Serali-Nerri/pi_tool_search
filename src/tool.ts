...
export function createToolSearchDefinition(
	...
	return {
		...
		promptSnippet: "Activate deferred tools by exact name when their capability is needed",
		promptGuidelines: ["Use tool_search with exact tool_names from its manifest before calling deferred tools."],
