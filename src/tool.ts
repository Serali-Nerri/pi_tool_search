...
export function createToolSearchDefinition(
	...
	return {
		...
		promptSnippet: "Find and activate tools not provided upfront, by exact name from the manifest",
		promptGuidelines: ["When a needed tool was not provided upfront, use tool_search to load it, then call the loaded tool directly."],
